...
export default function Home() {
  return (
    <div className="page-wrapper">
      ...
      <section className="hero">
        <div className="hero__overlay" />
        {/* FOTOĞRAF: hero arka plan görseli için public/images/hero-bg.jpg ekleyin */}
        <div className="container hero__content">
          <div className="hero__badge">Karaman'ın Spor Akademisi</div>
          <h1 className="hero__title">
            Geleceğin <span className="gold-text">Şampiyonlarını</span><br />
      ...
      <section className="section why-section">
        <div className="container why-inner">
          ...
          {/* FOTOĞRAF: why bölümü yan görseli için public/images/why-photo.jpg ekleyin */}
          <div className="why-image">
            <div className="why-image__placeholder">
              <span>📸</span>
              <p>Antrenman Fotoğrafı</p>
      ...
      <section className="section academy-highlight">
        <div className="container">
          <div className="academy-highlight__inner">
            ...
            {/* FOTOĞRAF: futbol akademisi görseli için public/images/football.jpg ekleyin */}
            <div className="academy-highlight__image">
              <div className="why-image__placeholder">
                <span>⚽</span>
                <p>Futbol Antrenman</p>
                <small>football.jpg</small>
              </div>
            </div>
          </div>
        </div>
